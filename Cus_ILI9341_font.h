#ifndef __CUS_ILI9341_FONT_H__
#define __CUS_ILI9341_FONT_H__

#include "Cus_ILI9341.h"
#include <stdint.h>

#if (ILI9341_FONT_12 != 0)
#define ILI9341_FONT_12_WIDTH       6
#define ILI9341_FONT_12_HEIGHT      12
#define ILI9341_FONT_12_SIZE        12

const uint8_t ili9341_font_12x6[95][ILI9341_FONT_12_SIZE] = {
...
#if (ILI9341_FONT_16 != 0)
#define ILI9341_FONT_16_WIDTH       8
#define ILI9341_FONT_16_HEIGHT      16
#define ILI9341_FONT_16_SIZE        16

const uint8_t ili9341_font_16x8[95][ATK_MD0280_FONT_16_CHAR_SIZE] = {
...
#if (ILI9341_FONT_24 != 0)
#define ILI9341_FONT_24_WIDTH      12
#define ILI9341_FONT_24_HEIGHT    24
#define ILI9341_FONT_24_SIZE        36

const uint8_t ili9341_font_24x12[95][ILI9341_FONT_24_SIZE] = {
...
#if (ILI9341_FONT_32 != 0)
#define ILI9341_FONT_32_WIDTH       16
#define ILI9341_FONT_32_HEIGHT      32
#define ILI9341_FONT_32_SIZE        64

const uint8_t ili9341_font_32x16[95][ILI9341_FONT_32_SIZE] = {
